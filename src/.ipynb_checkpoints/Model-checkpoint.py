...
class Run_Models():
    ...
    def regression(self,df):    
        ...
        axs[0].fill_between(y_preds.index, y_preds.randomforest, y_preds.actual, color='red', alpha=.2)
        ...
        axs[0].fill_between(y_preds.index, y_preds.olslinear, y_preds.actual, color='red', alpha=.2)
        ...
        axs[0].fill_between(y_preds.index, y_preds.olssmf, y_preds.actual, color='red', alpha=.2)
